...
class ReviewServiceImplTest {
	...
	void testInsertReview() throws Exception {
		Review sampleInput = new Review("good", "package is good", 5, "09-01-2022", "mansi");
		Review expectedOutput = new Review("good", "package is good", 5, "09-01-2022", "mansi");
	...
	void testGetReviewByReviewId() throws Exception {
		Review sampleOutput = new Review("good", "package is good", 5, "09-01-2022", "mansi");
	...
	void testGetAllReviews() throws Exception {
		Review review1 = new Review("good", "package is good", 5, "09-01-2022", "mansi");

		Review review2 = new Review("good", "package is good", 5, "09-01-2022", "mansi");
